...
class NoteModel extends AbstractModel implements ModelInterface
{
  ...
  public function count(): int
  {
    try {
      ...
      throw new StorageException('Nie udało się pobrać infromacji o liczbie notatek', 400, $e);
    }
  }

  public function searchCount(string $phrese): int
  {
    try {
      $phrase = $this->conn->quote('%' . $phrese . '%', PDO::PARAM_STR);
